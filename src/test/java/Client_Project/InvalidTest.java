...
public class InvalidTest extends BaseClass {
	...
	@Test(priority = 3, dataProvider = "InvalidTestData", dataProviderClass = ReadExcelData.class, dependsOnMethods = "LeadPageAccess")
